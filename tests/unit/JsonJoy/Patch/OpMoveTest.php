...
final class OpMoveTest extends TestCase
{
    public function testCanInstantiate(): void
    {
        $op = new JsonJoy\Patch\OpMove("/foo/bar", '/gg');
    ...
    {
        $op = new JsonJoy\Patch\OpMove("/foo", '/bar');
        $doc = (object) [
            'bar' => 123,
        ];
        $res = $op->apply($doc);
        $this->assertEquals(true, JsonJoy\Json::equal($res, (object) ['foo' => 123]));
    }
}
